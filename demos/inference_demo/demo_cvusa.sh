#!/bin/bash
# Demo script for CVUSA dataset inference

GPU_DEVICE=${1:-0}

# Demo paths
DEMO_DIR="demo_data/CVUSA"
WORK_DIR="work_dirs/visualize_result"
SAT_IMG="${DEMO_DIR}/satellite/0040836.jpg"
SKY_IMG="${DEMO_DIR}/panorama/0040836.jpg"
...
for img in $DEMO_DIR/satellite/*.jpg; do
