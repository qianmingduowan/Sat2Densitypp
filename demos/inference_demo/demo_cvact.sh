#!/bin/bash
# Demo script for CVACT dataset inference

GPU_DEVICE=${1:-0}

# Demo paths
DEMO_DIR="demo_data/CVACT"
WORK_DIR="work_dirs/visualize_result"
SAT_IMG="${DEMO_DIR}/satellite/aOIFiGzL6fvf0_YZIlyqFw_satView_polish.png"
SKY_IMG="${DEMO_DIR}/panorama/aOIFiGzL6fvf0_YZIlyqFw_grdView.png"
